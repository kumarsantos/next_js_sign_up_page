    ...
    const getUserData = async () => {
      try {
        const res = await fetch(
          `${process.env.NEXT_PUBLIC_DOMAIN}/api/crud?userId=${userId}`
        );
      ...
      <div className="flex relative h-full ">
        <section className=" relative bg-blue-100 px-14 lg:max-w-[40%] md:max-w-[40%] hidden md:inline-block lg:inline-block w-full lg:min-h-screen md:min-h-screen space-y-8">
          ...
          <p className=" tracking-wider text-center">
            I have not seen anything as affordable and easy to use as Zoho
            Books. The reports are simple to run and can be scheduled to
            generate automatically. As a small business owner, I no longer worry
            about ageing receivables with the automatic payment reminders in
            Zoho Books.
          </p>
